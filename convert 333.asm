...
LOOP:
    ...
    #A == 65, Z == 90
    blt $t1, 65, LOOP2 #if $t1 is less than 65, branch to SKIP
    bgt $t1, 90, LOOP2 #if $t1 is greater than 90, branch to SKIP
...
LOOP2:
    blt $t1, 97, SKIP #if $t1 is less than 65, branch to SKIP
    bgt $t1, 122, SKIP #if $t1 is greater than 90, branch to SKIP
